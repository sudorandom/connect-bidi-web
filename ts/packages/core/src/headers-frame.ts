 ...
 * equivalent HeaderMessage type in internal/connectprotocol, and
 * @sudorandom/connect-bidi-web defines the same shape for the browser client
 * in its own headers-frame.ts. This is a deliberate, small mirror of that
 * definition: core does not depend on the browser package, so the three
 * definitions are kept visibly in sync by hand rather than shared.
 */
